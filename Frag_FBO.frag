...
void main()
{
	...
	// ************** TEXTÚRÁZÁS ******************
	// kiszedjük az értékeket a splatMapTexture-bõl
	...
	// mindegy egyes textúrát interpolálunk a feketével a megfelelõ splatmap érték alapján,
	...
	float sandBlend = 1.0 - smoothstep(0.15, 0.2, height); // kivonjuk 1-bõl, hogy ha magasabban vagyunk, mint a határ, 0 legyen
